    ...
    <div className="dashboard-root">
      <header className="dashboard-header">
        ...
        <div className="controls">
          {/* The Charts component has internal state dropdown - keep UI simple here */}
        </div>
      </header>
      ...
      <main className="dashboard-main">
        <section className="left">
          <div className="card">
            <h3>State Groundwater Summary</h3>
            <Charts />
          </div>
        ...
        <aside className="right">
          <div className="card">
            <h4>Map Legend</h4>
            <div className="legend-item"><span className="dot green"></span>Good (&gt;15m)</div>
            <div className="legend-item"><span className="dot yellow"></span>Moderate (10-15m)</div>
            <div className="legend-item"><span className="dot red"></span>Critical (&lt;10m)</div>
          </div>
...
export default function Dashboard() {
  return (
    <div className="dashboard-root">
      ...
      <div className="alert-warn"> {/* conditional: show only when error */}
        {/* If the data load fails, your app should render an error box here */}
      </div>
